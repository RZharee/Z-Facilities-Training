...
const KEY="zfacilities_workorders_v1";
...
$("woForm").onsubmit=e=>{
 ...
 localStorage.setItem(KEY,JSON.stringify(workorders));
 renderHistory(); show("deviceView");
};
show("searchView");